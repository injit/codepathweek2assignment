...
if(is_post_request()) {
  ...
  if(isset($_POST['name'])) { $state['name'] = h(db_escape($db, $_POST['name'])); }
  if(isset($_POST['code'])) { $state['code'] = h(db_escape($db, $_POST['code'])); }
  if(isset($_POST['country_id'])) { $state['country_id'] = h(db_escape($db, $_POST['country_id'])); }
