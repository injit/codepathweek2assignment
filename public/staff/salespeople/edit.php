...
if(is_post_request()) {
  ...
  if(isset($_POST['first_name'])) { $salesperson['first_name'] = h(db_escape($db, $_POST['first_name'])); }
  if(isset($_POST['last_name'])) { $salesperson['last_name'] = h(db_escape($db, $_POST['last_name'])); }
  if(isset($_POST['phone'])) { $salesperson['phone'] = h(db_escape($db, $_POST['phone'])); }
  if(isset($_POST['email'])) { $salesperson['email'] = h(db_escape($db, $_POST['email'])); }
